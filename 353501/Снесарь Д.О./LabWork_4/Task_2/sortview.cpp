...
long long SortView::doBinSearch(long long n)
{
    ...
    while (r > l) {
        ...
        visualArray[m]->setBrush(Qt::white);
        visualArray[l]->setBrush(Qt::white);
        visualArray[r]->setBrush(Qt::white);
        if (array[m] < n) {
            l = m + 1;
        } else if (array[m] > n) {
            r = m - 1;
...
void SortView::hilight(long long index)
{
    ...
    visualArray[index]->setBrush(Qt::white);
...
void SortView::swapRect(long long index1, long long index2)
{
   ...
   /* QEventLoop eventLoop;
    ...
    visualArray[index2]->setBrush(Qt::white);
    visualArray[index1]->setBrush(Qt::white);
...
void SortView::setRect(long long h, long long pos)
{
    ...
    visualArray[pos]->setBrush(Qt::white);
}
