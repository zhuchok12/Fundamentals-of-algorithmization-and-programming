#include "interpolition.h"
#include <QDebug>
#include <cmath>
Interpoliation::Interpoliation() {}



void Interpoliation::swap(int &i, int &j)
{
    int sw = i;
    i = j;
    j = sw;
...
void Interpoliation::interpolation(QVector<int> &arr, QVector <QVector<int>>& motionVector)
{
    int n = 0;
