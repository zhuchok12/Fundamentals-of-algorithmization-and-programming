...
Rocket::Rocket()
{
    ...
    line4->setPen(pen);
    //nouse
    line5 = new QGraphicsLineItem(-50,-120, 0,-250, this);
    line5->setPen(pen);
    line6 = new QGraphicsLineItem(0,-250,50,-120, this);
    line6->setPen(pen);
    //left wihg
    line7 = new QGraphicsLineItem(-50,30,-80,30, this);
    line7->setPen(pen);
    line8 = new QGraphicsLineItem(-80,30,-50,-50, this);
    line8->setPen(pen);
    //right wing
    line9 = new QGraphicsLineItem(50,30,80,30, this);
    line9->setPen(pen);
    line10 = new QGraphicsLineItem(80,30,50,-50, this);
    line10->setPen(pen);
    //nozzle
    line11 = new QGraphicsLineItem(30,30,30,40, this);
    line11->setPen(pen);
    line12 = new QGraphicsLineItem(-30,30,-30,40, this);
    line12->setPen(pen);
...
void Rocket::Start()
{
    ...
    if(fireline1 == nullptr){
        QPen pen(Qt::red);
        pen.setWidth(3);
        fireline1 = new QGraphicsLineItem(30,42,15,60, this);
