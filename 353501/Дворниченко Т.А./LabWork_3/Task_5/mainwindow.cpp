...
{
    QString directoryPath = QFileDialog::getExistingDirectory(nullptr, QObject::tr("Выберите папку"), "/home/timofey", QFileDialog::ShowDirsOnly | QFileDialog::DontResolveSymlinks);
