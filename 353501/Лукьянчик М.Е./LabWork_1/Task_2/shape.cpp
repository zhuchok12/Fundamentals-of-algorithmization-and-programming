...
void Shape::NewCenterX(int NewCentreX)
{
    center = QPoint(center.rx()+NewCentreX,center.ry());
}

void Shape::NewCenterY(int NewCentreY)
{
    center = QPoint(center.rx(),center.ry()+NewCentreY);
}
