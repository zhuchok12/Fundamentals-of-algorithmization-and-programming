...
{
    return (qAbs(Figure::endPoint.y()-Figure::startPoint.y())+qAbs(Figure::endPoint.x()-Figure::startPoint.x()))*qAbs(3)/6;
}

float Hexagon::area()
{
    return (qAbs(Figure::endPoint.y()-Figure::startPoint.y())*qAbs(Figure::endPoint.x()-Figure::startPoint.x()))*qAbs(3)*M_PI/3;
}

float Hexagon::centerY(){
    return(qAbs(Figure::endPoint.y()-Figure::startPoint.y())/2);
}

float Hexagon::centerX(){
