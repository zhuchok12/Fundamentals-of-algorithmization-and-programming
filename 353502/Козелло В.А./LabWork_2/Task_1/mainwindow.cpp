    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->spinBoxBirthDay->setValue(MAXIM_BIRTH_DAY);
    ui->spinBoxBirthMonth->setValue(MAXIM_BIRTH_MONTH);
    ui->spinBoxBirthYear->setValue(MAXIM_BIRTH_YEAR);
    ...
    birthdayDate.setDate(MAXIM_BIRTH_DAY, MAXIM_BIRTH_MONTH, MAXIM_BIRTH_YEAR);
}
