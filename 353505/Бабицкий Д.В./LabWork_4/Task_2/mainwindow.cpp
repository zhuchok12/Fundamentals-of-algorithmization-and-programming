...
MainWindow::MainWindow()
  ...
  connect(ui->moduloInput, &QSpinBox::valueChanged, this,
          &MainWindow::searchUpdateVisVector);
...
void MainWindow::fullUpdateVisVector() {
  ...
  Sorter::InterpolatoinSort(visvec);
...
void MainWindow::updateVisVector() {
  ...
  int powdered = -1;
  if(indexFound != -1) {
    powdered = Search::BinPow(indexFound, visvec->Size(), ui->moduloInput->value());
  }
