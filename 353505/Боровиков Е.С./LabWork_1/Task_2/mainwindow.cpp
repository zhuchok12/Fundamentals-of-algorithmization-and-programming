...
mainWindow::mainWindow(QWidget *) {
    ...
    auto *buttonsVBox = new QHBoxLayout;

    auto *HBox = new QHBoxLayout(this);


    //Add buttons
    triangleButton = new QRadioButton("Треугольник");
    ...
    starButton = new QRadioButton("Звезда");
    ...
    auto *label1 = new QLabel("Периметр");
    textPerimeter = new QLabel();
    auto *label2 = new QLabel("Площадь");
    textSquare = new QLabel();
    auto *label3 = new QLabel("Цент масс");
    ...
    // Actions
    drawButton = new QRadioButton("Рисовать");
    actionsVBox->addWidget(drawButton);
    drawButton->setChecked(true);

    moveButton = new QRadioButton("Двигать");
    actionsVBox->addWidget(moveButton);

    auto sizeHBox = new QHBoxLayout;
    sizeP = new QPushButton("Размер+");
    sizeM = new QPushButton("Размер-");
    ...
    auto resizeTextLabel = new QLabel("Размер");
    ...
    auto rotateText = new QLabel("Поворот");
...
void mainWindow::mousePressEvent(QMouseEvent *me) {
    if (drawButton->isChecked()) {
        if (selectedFigureID < 9 && selectedFigureID > 0) {
            figuresArray[selectedFigureID]->mousePressing(me);
        }
        else {
