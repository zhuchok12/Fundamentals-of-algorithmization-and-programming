    ...
    , ui(new Ui::MainWindow)
{
    ...
    setWindowTitle("Посчет папок и подфайлов");
...
void MainWindow::on_pushButton_clicked()
{
    ...
    ui->label_sf->setText("Подсчитываем...");
    ui->label_files->setText("Подсчитываем...");
    ...
    if (!directoryPath.isEmpty()){
        ...
        QObject::connect(thread, &QThread::started, [&]{
            ...
            ui->label_sf->setText(QString::number(d) + " Файлы");
            ui->label_files->setText(QString::number(f) + " Подфайлы");
        });
        thread->start();
    }
}
