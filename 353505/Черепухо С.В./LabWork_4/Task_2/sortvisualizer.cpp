...
void SortVisualizer::visualizeArray() {
    ...
    for (int i = 0; i < _size; ++i) {
        ...
        _visualArray[i]->setBrush(QBrush(Qt::black));
...
void SortVisualizer::slotSetComparison(int *firstElement, int *secondElement) {
    ...
    _visualArray[firstElement - _array]->setBrush(QBrush(Qt::red));
    _visualArray[secondElement - _array]->setBrush(QBrush(Qt::red));
    _visualArray[firstElement - _array]->setPen(QPen(Qt::red));
    _visualArray[secondElement - _array]->setPen(QPen(Qt::red));
    _scene->update();
}
...
void SortVisualizer::slotEndComparison(int *firstElement, int *secondElement) {
    ...
    _visualArray[firstElement - _array]->setBrush(QBrush(Qt::black));
    _visualArray[secondElement - _array]->setBrush(QBrush(Qt::black));
    _visualArray[firstElement - _array]->setPen(QPen(Qt::black));
    _visualArray[secondElement - _array]->setPen(QPen(Qt::black));
    _scene->update();
}
