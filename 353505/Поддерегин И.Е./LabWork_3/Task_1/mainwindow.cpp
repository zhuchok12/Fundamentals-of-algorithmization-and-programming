    ...
    : QWidget(parent)
{
    ...
    connect(button, &QPushButton::clicked, this, &MainWindow::convert);
}
...
void MainWindow::convert()
{
    ...
    if (ok)
    {
        QString binaryQString = toBinary(number, 1600);
...
QString MainWindow::toBinary(long double number, int precision)
{
    QString binary;
    if (number < 0)
    {
