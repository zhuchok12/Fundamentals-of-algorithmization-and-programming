    ...
    : QWidget{parent}
{
    ...
    showMassCenterChange->setGeometry(550, 25, 300, 25);
    ...
    SetRotation->setGeometry(250, 0, 300, 25);
    SetScale->setGeometry(250, 25, 300, 25);
    EnableMoving->setGeometry(250, 50, 500, 25);
    Info->setGeometry(0,0, 500, 75);
    Info->setParent(this);
    ...
    RotateSettings->setFixedSize(700, 200);
    ...
    ScaleSettings->setFixedSize(750, 250);
...
void GeometryShape::on_ConfirmRotationSettings_clicked()
{
    ...
    if (inputAreNumbers && animDuration > 0 && animDuration < 50) {
        RotateSettings->hide();
