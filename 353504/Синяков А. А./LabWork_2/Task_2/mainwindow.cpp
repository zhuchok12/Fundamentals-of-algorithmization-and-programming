    ...
    , ui(new Ui::MainWindow)
{
    ...
    QString windowStyle = "background-color: #550527;";
...
/*
    // Установка стилей для QTextEdit
    ...
    ui->bookListTextEdit->setStyleSheet(textEditStyle);

    // Установка стилей для QLineEdit
    ...
    ui->bookCodeLineEdit->setStyleSheet(lineEditStyle);
