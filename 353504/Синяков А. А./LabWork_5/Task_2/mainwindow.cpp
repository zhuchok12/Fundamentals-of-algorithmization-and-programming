...
void MainWindow::on_pushButton_3_clicked()
{
    ...
    if(n==s2.size())
        n++;
    MyString::memcpy(s1.data(),s2.data(),n);
...
void MainWindow::on_pushButton_4_clicked()
{
    ...
    if(n==s2.size())
        n++;
    MyString::memmove(s1.data(),s2.data(),n);
...
{
    MyString::strcpy(s1.data(),s2.data());
    update_textes();
}
...
void MainWindow::on_pushButton_6_clicked()
{
    ...
    MyString::strncpy(s1.data(),s2.data(),n);
    update_textes();
}

void MainWindow::on_pushButton_7_clicked()
{
    MyString::strcat(s1.data(),s2.data());
...
void MainWindow::on_pushButton_8_clicked()
{
    ...
    MyString::strncat(s1.data(),s2.data(),n);
    update_textes();
...
void MainWindow::on_pushButton_9_clicked()
{
    ...
    int r=MyString::memcmp(s1.data(),s2.data(),n);
    if(r==0)
...
void MainWindow::on_pushButton_10_clicked()
{
    ...
    int r=MyString::strcmp(s1.data(),s2.data());
    if(r==0)
        ui->result->setText("S1 = S2");
    if(r==1)
        ui->result->setText("S1 > S2");
...
void MainWindow::on_pushButton_11_clicked()
{
    ...
    int r=MyString::strcoll(s1.data(),s2.data());
    if(r==0)
        ui->result->setText("S1 = S2");
    if(r==1)
        ui->result->setText("S1 > S2");
...
void MainWindow::on_pushButton_12_clicked()
{
    ...
    int r=MyString::strncmp(s1.data(),s2.data(),n);
    if(r==0)
        ui->result->setText("S1 = S2");
    if(r==1)
        ui->result->setText("S1 > S2");
...
void MainWindow::on_pushButton_13_clicked()
{
    ...
    int r=MyString::strxfrm(s1.data(),s2.data(),n);
...
{
    std::string s="S1 size: "+std::to_string(MyString::strlen(s1.data()))+"\tS2: size"+std::to_string(MyString::strlen(s2.data()));
