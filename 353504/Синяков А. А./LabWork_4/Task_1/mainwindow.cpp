...
{
    ui->setupUi(this);
    QString styleSheet2 = "background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #2E2E4F, stop:1 #D70060);";
    ui->graphicsView->setStyleSheet(styleSheet2);
...
QFrame#line {
    background-color: #2E2E4F; /* Цвет линии */
